...
library if you use local libraries into your code;
...
with inside the sub-directory `R` for the R source code and the file
`DESCRIPTION` for meta-informations on your package.
...
Now, you just need to run Roxygen before building and installing your
package.
