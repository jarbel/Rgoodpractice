...
Create a R profile file '.Rprofile' with the path to your local library if needed into your code;
e.g. .libPaths(new="~/R_libs")
...
Create a directory with the name of your package, e.g. 'MyPackage', with inside the sub-directory 'R' for the R source code and the file 'DESCRIPTION' for meta-informations on your package.
...
Description: Basic package to plot 2 ggplot2 plots.
License: GPLv3
